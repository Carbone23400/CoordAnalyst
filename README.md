...
### An educational tool helping students predict oxidation, geometry, number of d electrons, coordination number of a coordination complex ; visualize it in 2D, 3D ; and draw a reliable IR and Raman spectra from streches in databases for common ligands.
...
<figure style="text-align: center;">
  <img src="notebooks/app_display/side_bar.png" width="200">
  <figcaption>
