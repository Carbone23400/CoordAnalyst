...
### An educational tool helping students predict oxidation, geometry, number of d electrons, coordination number of a coordination complex and visualize it in 2D, 3D and draw a reliable IR and Raman spectra from streches in databases for common ligands.
